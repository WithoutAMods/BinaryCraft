...
class WireBlockData : INBTSerializable<CompoundTag> {
    var level = 1
        private set
    private val levelData = Array(4) { LevelData() }
    ...
    override fun deserializeNBT(nbt: CompoundTag) {
        ...
        for (i in 0 until maxOf(levelDataTag.size, levelData.size)) {
    ...
    companion object {
        private class LevelData : INBTSerializable<CompoundTag> {
            var isSimple = false
            ...
            override fun deserializeNBT(nbt: CompoundTag) {
                ...
                if (intArray.size == 4) {
                    ...
                    for (i in 0 until maxOf(intArray.size, sideData.size)) {
